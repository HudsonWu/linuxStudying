...
There is no a standard way to set a different ctime timestamp
...
> unset NOW
6. To speedup modification and reduce the possible impact, execute the above command as follows:
